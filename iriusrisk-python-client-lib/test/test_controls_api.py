...
from iriusrisk_python_client_lib.api.controls_api import ControlsApi  # noqa: E501
...
class TestControlsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = iriusrisk_python_client_lib.api.controls_api.ControlsApi()  # noqa: E501
